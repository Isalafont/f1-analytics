...
namespace :f1 do
  ...
  task :fetch_race_results, [:round] => :environment do |_t, args|
    season = ENV["SEASON"]&.to_i || Date.current.year
  ...
  task seed_2025: :environment do
    ...
    drivers_data = [
      { first_name: "Max", last_name: "Verstappen", code: "VER", number: 1, team: "Red Bull Racing",
        nationality: "Dutch" },
      { first_name: "Sergio", last_name: "P\u00E9rez", code: "PER", number: 11, team: "Red Bull Racing",
        nationality: "Mexican" },
      { first_name: "Charles", last_name: "Leclerc", code: "LEC", number: 16, team: "Ferrari",
      ...
      { first_name: "Andrea", last_name: "Kimi Antonelli", code: "ANT", number: 12, team: "Mercedes",
        nationality: "Italian" },
      { first_name: "Lando", last_name: "Norris", code: "NOR", number: 4, team: "McLaren", nationality: "British" },
      { first_name: "Oscar", last_name: "Piastri", code: "PIA", number: 81, team: "McLaren",
        nationality: "Australian" },
      { first_name: "Fernando", last_name: "Alonso", code: "ALO", number: 14, team: "Aston Martin",
        nationality: "Spanish" },
      { first_name: "Lance", last_name: "Stroll", code: "STR", number: 18, team: "Aston Martin",
      ...
      { first_name: "Oliver", last_name: "Bearman", code: "BEA", number: 87, team: "Haas F1 Team",
        nationality: "British" },
      { first_name: "Esteban", last_name: "Ocon", code: "OCO", number: 31, team: "Haas F1 Team",
        nationality: "French" },
      ...
      { first_name: "Nico", last_name: "H\u00FClkenberg", code: "HUL", number: 27, team: "Sauber",
        nationality: "German" },
      { first_name: "Gabriel", last_name: "Bortoleto", code: "BOR", number: 5, team: "Sauber",
